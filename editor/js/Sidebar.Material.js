...
Sidebar.Material = function ( editor ) {
	...
	materialMetalnessRow.add( new UI.Text( '光泽度' ).setWidth( '90px' ) );
	...
	materialEmissiveRow.add( new UI.Text( '表层颜色' ).setWidth( '90px' ) );
	...
	materialSpecularRow.add( new UI.Text( '高光' ).setWidth( '90px' ) );
	...
	materialShininessRow.add( new UI.Text( '曝光' ).setWidth( '90px' ) );
	...
	materialSkinningRow.add( new UI.Text( '蒙皮' ).setWidth( '90px' ) );
	...
	materialNormalMapRow.add( new UI.Text( '自发光贴图' ).setWidth( '90px' ) );
	...
	materialDisplacementMapRow.add( new UI.Text( '取代地图' ).setWidth( '90px' ) );
	...
	materialRoughnessMapRow.add( new UI.Text( '粗糙贴图' ).setWidth( '90px' ) );
	...
	materialSpecularMapRow.add( new UI.Text( '高光贴图' ).setWidth( '90px' ) );
	...
	materialLightMapRow.add( new UI.Text( '灯光贴图' ).setWidth( '90px' ) );
	...
	materialAOMapRow.add( new UI.Text( '环境闭塞贴图' ).setWidth( '90px' ) );
	...
	materialEmissiveMapRow.add( new UI.Text( '反射贴图' ).setWidth( '90px' ) );
	...
	materialSideRow.add( new UI.Text( '侧面' ).setWidth( '90px' ) );
	...
	materialBlendingRow.add( new UI.Text( '混和物' ).setWidth( '90px' ) );
	...
	materialTransparentRow.add( new UI.Text( '浓度	' ).setWidth( '90px' ) );
	...
	materialAlphaTestRow.add( new UI.Text( '深度检验' ).setWidth( '90px' ) );
